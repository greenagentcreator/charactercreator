/**
 * Russian Translation Template (Delta Green Agent Creator)
 *
 * Translator guide:
 * 1) Replace each English value with Russian text. Do not change key names.
 * 2) Keep placeholders exactly as written: {name}, {totalPoints}, {remaining}, etc.
 * 3) Keep HTML tags and attributes unchanged (<a ...>, <strong>, id='...').
 * 4) Preserve spacing and punctuation around placeholders where possible.
 * 5) Do not remove keys. Every key in en.js must exist here.
 *
 * Game terms (suggested consistency — align with your table's preferred Russian DG terms)
 *
 * When finished:
 * - Send this file back 
 * - I will add ru to translations and the language switcher after review.
 */

export const ruTranslationTemplate = {
