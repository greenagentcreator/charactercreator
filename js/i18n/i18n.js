...
import { i18nData, languageLabels } from './translations.js?v=99fd89c';
import { syncRussianFontsWithLanguage } from '../utils/locale-fonts.js?v=99fd89c';
...
export function setLanguage(lang) {
    ...
    import('../utils/seo.js?v=99fd89c').then(({ updateSeoMeta }) => {
        updateSeoMeta(lang);
    }).catch(() => {});
    ...
    import('../utils/news.js?v=99fd89c').then(({ refreshNewsButton }) => {
        refreshNewsButton?.();
    }).catch(() => {});
}
