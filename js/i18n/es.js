export const es = {
    ...
    "meta_description": "Creador de personajes Delta Green y ficha de personaje online rellenable gratis. Crea agentes paso a paso—guarda, imprime y comparte. Sin registro ni anuncios. EN, DE, ES, FR, RU, PT.",
    ...
    "specify_type_placeholder_foreign_language": "Especificar idioma (p. ej., Francés, Español, Árabe)",
    "specify_type_placeholder_science": "Especificar campo (p. ej., Física, Biología, Química)",
    "specify_type_placeholder_art": "Especificar arte (p. ej., Pintura, Fotografía, Escultura)",
    "specify_type_placeholder_craft": "Especificar oficio (p. ej., Carpintería, Armería, Mecánica)",
    "specify_type_placeholder_pilot": "Especificar vehículo (p. ej., Avión, Barco, Helicóptero)",
    "specify_type_placeholder_military_science": "Especificar rama (p. ej., Tierra, Aire, Mar)",
    ...
    "traumatic_background_hard_experience_desc": "+10% Ocultismo; -5 COR; +10% a cinco habilidades cualesquiera (excepto Antinatural). Elimina un Lazo.",
    ...
    "hard_experience_skill_selection_label": "Escoge cinco habilidades para aumentar +10% (excepto Antinatural):",
    "hard_experience_skill_label": "Habilidad {number}:",
    "hard_experience_bond_removal_label": "Escoge un Lazo a eliminar:",
    "hard_experience_error_select_skills": "Para Experiencia dura, debes seleccionar cinco habilidades diferentes.",
