...
import { getCharacter, syncStatsFromAssignments } from '../model/character.js?v=17b4a1e';
import { STAT_ARRAYS, STAT_KEYS } from '../config/constants.js?v=17b4a1e';
...
import { attachTooltipListeners, renderInfoIcon } from '../utils/tooltips.js?v=17b4a1e';
