...
import { getCharacter, syncStatsFromAssignments } from '../model/character.js?v=1f4a5b4';
import { STAT_ARRAYS, STAT_KEYS } from '../config/constants.js?v=1f4a5b4';
import { t, translateAllElements } from '../i18n/i18n.js?v=1f4a5b4';
import { updateNavigationButtons } from '../app.js?v=1f4a5b4';
import { showInlineError, showFieldError } from '../utils/validation.js?v=1f4a5b4';
import { attachTooltipListeners, renderInfoIcon } from '../utils/tooltips.js?v=1f4a5b4';
