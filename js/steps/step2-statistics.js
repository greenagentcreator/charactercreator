...
import { getCharacter, syncStatsFromAssignments } from '../model/character.js?v=9e5a3d4';
import { STAT_ARRAYS, STAT_KEYS } from '../config/constants.js?v=9e5a3d4';
import { t, translateAllElements } from '../i18n/i18n.js?v=9e5a3d4';
import { updateNavigationButtons } from '../app.js?v=9e5a3d4';
import { showInlineError, showFieldError } from '../utils/validation.js?v=9e5a3d4';
import { attachTooltipListeners, renderInfoIcon } from '../utils/tooltips.js?v=9e5a3d4';
