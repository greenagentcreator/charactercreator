...
import { resetCharacter } from '../model/character.js?v=1a58e28';
import { getAllCharacters, deleteCharacter, updateCharacterName, importCharacter } from '../utils/storage.js?v=1a58e28';
import { getUnfinishedDrafts } from '../utils/unfinished-drafts.js?v=1a58e28';
import { t, translateAllElements, getCurrentLanguage } from '../i18n/i18n.js?v=1a58e28';
import { languageLabels, SUPPORTED_LIBRARY_LANGUAGES } from '../i18n/translations.js?v=1a58e28';
import { validateImportedCharacter } from '../utils/validation.js?v=1a58e28';
import { getPublicCharacters, importCharacterFromDatabase, reportCharacter, getPublicCharacterById } from '../utils/database.js?v=1a58e28';
import { resolveProfessionMetadata, getStandardProfessionFilters } from '../utils/profession-filter.js?v=1a58e28';
import { showModal, closeModal, showConfirmDialog, showPromptDialog, showAlertDialog } from '../utils/modal.js?v=1a58e28';
