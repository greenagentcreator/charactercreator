...
import { NEWS_ENTRIES } from '../data/news.js?v=17b4a1e';
import { COLLECTIONS } from '../config/database.js?v=17b4a1e';
import { t, getCurrentLanguage } from '../i18n/i18n.js?v=17b4a1e';
import { showModal } from './modal.js?v=17b4a1e';
import { escapeHtml, escapeAttr } from './escape-html.js?v=17b4a1e';
import { getDb } from './database.js?v=17b4a1e';
