...
import { firebaseConfig, COLLECTIONS, MODERATION_STATUS } from '../config/database.js?v=1b711ae';
import { getProfessionFilterKey } from './profession-filter.js?v=1b711ae';
import { SUPPORTED_LIBRARY_LANGUAGES } from '../i18n/translations.js?v=1b711ae';
import {
    sanitizeCharacterContent,
    validateCharacterContent,
    validateCharacterSchema
} from './content-moderation.js?v=1b711ae';
import { checkRateLimit, recordUpload } from './rate-limiter.js?v=1b711ae';
import { checkForDuplicate, recordCharacterFingerprint } from './duplicate-detector.js?v=1b711ae';
...
export async function importCharacterFromDatabase(characterDoc) {
    const { importCharacter } = await import('./storage.js?v=1b711ae');
