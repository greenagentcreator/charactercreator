...
import { firebaseConfig, COLLECTIONS, MODERATION_STATUS } from '../config/database.js?v=eb448c0';
import { getProfessionFilterKey } from './profession-filter.js?v=eb448c0';
import { SUPPORTED_LIBRARY_LANGUAGES } from '../i18n/translations.js?v=eb448c0';
import {
    sanitizeCharacterContent,
    validateCharacterContent,
    validateCharacterSchema
} from './content-moderation.js?v=eb448c0';
import { checkRateLimit, recordUpload } from './rate-limiter.js?v=eb448c0';
import { checkForDuplicate, recordCharacterFingerprint } from './duplicate-detector.js?v=eb448c0';
...
export async function importCharacterFromDatabase(characterDoc) {
    const { importCharacter } = await import('./storage.js?v=eb448c0');
