...
import { firebaseConfig, COLLECTIONS, MODERATION_STATUS } from '../config/database.js?v=addcaa9';
import { getProfessionFilterKey } from './profession-filter.js?v=addcaa9';
import { SUPPORTED_LIBRARY_LANGUAGES } from '../i18n/translations.js?v=addcaa9';
import {
    sanitizeCharacterContent,
    validateCharacterContent,
    validateCharacterSchema
} from './content-moderation.js?v=addcaa9';
import { checkRateLimit, recordUpload } from './rate-limiter.js?v=addcaa9';
import { checkForDuplicate, recordCharacterFingerprint } from './duplicate-detector.js?v=addcaa9';
...
export async function importCharacterFromDatabase(characterDoc) {
    const { importCharacter } = await import('./storage.js?v=addcaa9');
