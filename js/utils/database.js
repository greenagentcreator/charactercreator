...
import { firebaseConfig, COLLECTIONS, MODERATION_STATUS } from '../config/database.js?v=b5d21d8';
import { getProfessionFilterKey } from './profession-filter.js?v=b5d21d8';
import { SUPPORTED_LIBRARY_LANGUAGES } from '../i18n/translations.js?v=b5d21d8';
import {
    sanitizeCharacterContent,
    validateCharacterContent,
    validateCharacterSchema
} from './content-moderation.js?v=b5d21d8';
import { checkRateLimit, recordUpload } from './rate-limiter.js?v=b5d21d8';
import { checkForDuplicate, recordCharacterFingerprint } from './duplicate-detector.js?v=b5d21d8';
...
export async function importCharacterFromDatabase(characterDoc) {
    const { importCharacter } = await import('./storage.js?v=b5d21d8');
