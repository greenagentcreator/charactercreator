...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=5f80dbc';
import { saveCharacter } from './storage.js?v=5f80dbc';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=5f80dbc';
