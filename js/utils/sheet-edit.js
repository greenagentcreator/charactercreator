...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=1f4a5b4';
import { saveCharacter } from './storage.js?v=1f4a5b4';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=1f4a5b4';
