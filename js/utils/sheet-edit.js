...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=9e5a3d4';
import { saveCharacter } from './storage.js?v=9e5a3d4';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=9e5a3d4';
