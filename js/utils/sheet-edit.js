...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=5c9e92d';
import { saveCharacter } from './storage.js?v=5c9e92d';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=5c9e92d';
