...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=b5d21d8';
import { saveCharacter } from './storage.js?v=b5d21d8';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=b5d21d8';
