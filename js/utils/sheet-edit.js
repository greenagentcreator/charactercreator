...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=c8241d5';
import { saveCharacter } from './storage.js?v=c8241d5';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=c8241d5';
