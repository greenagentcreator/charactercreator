...
import { getCharacter, calculateDerivedAttributes } from '../model/character.js?v=3e17b91';
import { saveCharacter } from './storage.js?v=3e17b91';
...
export { escapeHtml, escapeAttr } from './escape-html.js?v=3e17b91';
